...
with st.sidebar:
    ...
    st.markdown('<a href="https://www.producthunt.com/products/openai-tools/reviews?utm_source=badge-product_review&utm_medium=badge&utm_souce=badge-openai&#0045;tools" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/product_review.svg?product_id=551389&theme=light" alt="OpenAI&#0032;Tools - Super&#0032;App&#0032;For&#0032;Fine&#0045;tuning&#0032;Datasets&#0044;&#0032;Jobs&#0044;&#0032;Metrics&#0032;&#0038;&#0032;Models | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a>', unsafe_allow_html=True)
    if DEBUG:
        ...
        with files_column:
            ...
            if len(files_res["data"]) > 0:
                with st.form("file_operation_form", clear_on_submit=True):
                    file_id_col, action_col = st.columns([2, 1])
                    with file_id_col:
